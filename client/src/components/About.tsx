  ...
  return (
    <section id='about' className='py-20 px-6 bg-gradient-to-b from-white to-blue-50'>
      ...
      <motion.div
        ...
        className='max-w-4xl mx-auto mb-16 overflow-hidden bg-white rounded-2xl shadow-xl md:flex'
      >
        {/* Image */}
        <motion.div
          ...
          viewport={{ once: true }}
          className='md:w-1/3 h-64 md:h-auto bg-blue-100'
        >
          <img
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className='p-8 md:p-12 md:w-2/3 flex flex-col justify-center'
        >
        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6'>
          {skills.map((skill, index) => (
            <motion.div
              ...
              className='rounded-xl p-6 bg-white shadow-sm hover:shadow-md transition-all flex flex-col items-center gap-3 border border-gray-50'
            >
              <img
